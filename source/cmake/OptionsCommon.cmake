...
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_FEATURES_H features.h)

# Check for headers
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_ERRNO_H errno.h)
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_LANGINFO_H langinfo.h)
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_MMAP sys/mman.h)
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_PTHREAD_NP_H pthread_np.h)
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_SYS_PARAM_H sys/param.h)
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_SYS_TIME_H sys/time.h)
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_SYS_TIMEB_H sys/timeb.h)
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_LINUX_MEMFD_H linux/memfd.h)
HBDINIT_CHECK_HAVE_INCLUDE(HAVE_SYSLOG_H syslog.h)

# Check for functions
HBDINIT_CHECK_HAVE_FUNCTION(HAVE_ALIGNED_MALLOC _aligned_malloc)
HBDINIT_CHECK_HAVE_FUNCTION(HAVE_ISDEBUGGERPRESENT IsDebuggerPresent)
HBDINIT_CHECK_HAVE_FUNCTION(HAVE_LOCALTIME_R localtime_r)
HBDINIT_CHECK_HAVE_FUNCTION(HAVE_MALLOC_TRIM malloc_trim)
HBDINIT_CHECK_HAVE_FUNCTION(HAVE_STRNSTR strnstr)
HBDINIT_CHECK_HAVE_FUNCTION(HAVE_TIMEGM timegm)
HBDINIT_CHECK_HAVE_FUNCTION(HAVE_VASPRINTF vasprintf)
HBDINIT_CHECK_HAVE_FUNCTION(HAVE_VSYSLOG vsyslog)
HBDINIT_CHECK_HAVE_FUNCTION(HAVE_ALLOCA alloca)

# Check for symbols
HBDINIT_CHECK_HAVE_SYMBOL(HAVE_REGEX_H regexec regex.h)
if (NOT (${CMAKE_SYSTEM_NAME} STREQUAL "Darwin"))
HBDINIT_CHECK_HAVE_SYMBOL(HAVE_PTHREAD_MAIN_NP pthread_main_np pthread_np.h)
endif ()
# Windows has signal.h but is missing symbols that are used in calls to signal.
HBDINIT_CHECK_HAVE_SYMBOL(HAVE_SIGNAL_H SIGTRAP signal.h)

# Check for struct members
HBDINIT_CHECK_HAVE_STRUCT(HAVE_STAT_BIRTHTIME "struct stat" st_birthtime sys/stat.h)
HBDINIT_CHECK_HAVE_STRUCT(HAVE_TM_GMTOFF "struct tm" tm_gmtoff time.h)
HBDINIT_CHECK_HAVE_STRUCT(HAVE_TM_ZONE "struct tm" tm_zone time.h)
