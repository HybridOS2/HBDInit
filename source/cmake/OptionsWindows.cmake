...
set(HBDInit_FRAMEWORK_HEADERS_DIR ${CMAKE_BINARY_DIR}/HBDInit/Headers)
set(HBDInit_PRIVATE_FRAMEWORK_HEADERS_DIR ${CMAKE_BINARY_DIR}/HBDInit/PrivateHeaders)

# Override derived sources directories
set(WTF_DERIVED_SOURCES_DIR ${CMAKE_BINARY_DIR}/WTF/DerivedSources)
set(HBDInit_DERIVED_SOURCES_DIR ${CMAKE_BINARY_DIR}/HBDInit/DerivedSources)

# Override library types
set(HBDInit_LIBRARY_TYPE OBJECT)
set(HBDInitTestSupport_LIBRARY_TYPE OBJECT)
